    ...
    <div class="row about-body">
        ...
        <div class="col-sm-12 blog-main">
            <div class="blog-body expansion">
                ...
                <div class="info">
                    本站为非商业化站点，无盈利性质，为博主个人博客。本站二次开发于 <a href="https://gitee.com/yadong.zhang/DBlog" title="" data-toggle="tooltip" data-placement="right" target="_blank" data-original-title="janker的个人技术博客"><strong>Janker's Blog</strong></a>。<br>
                </div>
